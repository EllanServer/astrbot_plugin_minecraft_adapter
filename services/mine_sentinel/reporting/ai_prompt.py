...
class AIReportPromptBuilder:
    ...
    def prompt_text(
        ...
        return (
            ...
            "优先逐字使用 fallback 中已有的 affected_plugins、affected_log_files、affected_worlds、"
            "affected_positions、players 和 first_seen_ts/last_seen_ts；字段为空时必须明确证据未提供，"
            "不得编造插件、玩家、世界、坐标或文件。"
            ...
            "最终事件管理报告、风险计数、事实定位、检查方案和排序由本地确定性渲染器生成，"
            "你只提供上述绑定 issue 的补充措辞。"
